...
class NewFilterButton extends Button {
  ...
  clickHandler(_event) {
    ...
    // http://127.0.0.1:9200/_plugin/kibana/app/kibana#/discover?_g=()&_a=(columns:!(_source),filters:!(),index:'155fb710-1370-11e9-859e-35ec3c707e4d',interval:auto,query:(language:kuery,query:create_and_ship),sort:!('@timestamp',desc))
